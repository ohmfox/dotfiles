...
sudo scutil --set ComputerName "arcana"
sudo scutil --set HostName "arcana"
sudo scutil --set LocalHostName "arcana"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "arcana"
